...
test.describe('Cost Report', () => {
  ...
  test('should display cost report page with heading', async ({ page }) => {
    await page.goto('/Reporting/CostReport');
    await expect(page.locator('h2')).toHaveText('Cost Report');
    await expect(page.locator('h3').first()).toBeVisible();
  });

  test('should show supplement costs table with seeded data', async ({ page }) => {
    await page.goto('/Reporting/CostReport');
    await expect(page.locator('h2')).toHaveText('Cost Report');
  ...
  test('should show family member costs table', async ({ page }) => {
    await page.goto('/Reporting/CostReport');
    await expect(page.locator('h2')).toHaveText('Cost Report');
  ...
  test('should show grand total', async ({ page }) => {
    await page.goto('/Reporting/CostReport');
    await expect(page.locator('h2')).toHaveText('Cost Report');
